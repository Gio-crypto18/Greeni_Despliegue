...
public class EspecieController {
    ...
    public ResponseEntity<?> ObtenerCantidad() {
        ...
        List<Object[]> fila = es.quantityEspecie();  // ⬅ CORRECTO
        ...
        for (Object[] s : fila) {
            ...
            dto.setNombreC((String) s[0]);  // ⬅ String OK
            dto.setQuantityEspecie(((Number) s[1]).intValue()); // ⬅ Correcto para cualquier tipo numérico
            listaDTO.add(dto);
        }
